...
const _Dirk = () => {
    ...
    return (
        <g transform="translate(-425.769523 -118.518010)">
          <defs>
            <pattern xlinkHref={`#${id1}`} patternTransform="matrix(0.07359227,-0.04315335,0.06835065,0.09574659,43.469721,89.509081)" id={id0}/>
            <pattern patternUnits="userSpaceOnUse" width="50.260043" height="37.694409" patternTransform="matrix(0.26458331,0,0,0.26458331,39.526125,62.056557)" id={id1}>
          ...
          <g transform="matrix(3.78389 0 0 3.78389 108.956 -21.4875)">
            <path fill="none" stroke="#000000" strokeWidth="8.42331" strokeLinecap="round" strokeLinejoin="miter" strokeDasharray="none" strokeOpacity="1" d="m 94.595015,59.743651 c 0.802294,-2.431678 1.26218,-4.517667 1.299284,-6.417558 0.04213,-2.157117 -0.240268,-2.491029 -1.052186,-5.144247" />
            <path fill="none" stroke="#000000" strokeWidth="4.81332" strokeLinecap="round" strokeLinejoin="miter" strokeDasharray="none" strokeOpacity="1" d="M 84.853966,73.607253 C 82.210615,61.76944 84.060073,59.885824 94.365788,61.634831" />
            <path fill={`url(#${id0})`} fillOpacity="1" strokeWidth="0.074097" d="m 88.962361,58.931701 c -1.324127,-1.254 -1.154427,-4.143577 0.4857,-8.49949 0.767668,-2.038802 0.518111,-6.463228 2.883664,-7.365376 4.748266,-1.810842 7.199867,3.055624 7.708195,7.849224 0.43479,4.100177 -0.708539,8.486415 -1.502385,9.031264 -7.201596,0.342111 -8.647207,-0.136801 -9.575174,-1.015622 z" />
            <path fill="none" stroke="#000000" strokeWidth="4.21166" strokeLinecap="round" strokeLinejoin="miter" strokeDasharray="none" strokeOpacity="1" d="m 94.599606,47.662767 c -0.489627,5.257924 -4.852262,7.186259 -10.872668,6.755915"  />
            <circle fill="#000000" stroke="#000000" strokeWidth="4.21166" strokeLinecap="round" strokeDasharray="none" stopColor="#000000" cx="90.070145" cy="38.947254" r="1.9468364"/>
          </g>
        </g>
    );
}

const Dirk = withSizePositionAngle(_Dirk, 62.088463, 138.516238);
