...
Bijvoorbeeld: we leggen een kubusvormig blokje kurk met een zijde van $5{,}00 \si{ cm}$ op een weegschaal en lezen af dat het blokje een massa heeft van $26 \si{ g}$. Dan is de massadichtheid van kurk:
$$
\begin{aligned}
\rho &= \frac{\si{m}}{\si{V}} \\
&= \frac{26 \si{ g}}{5{,}00 \si{ cm} \cdot 5{,}00 \si{ cm} \cdot 5{,}00 \si{ cm}}\\
