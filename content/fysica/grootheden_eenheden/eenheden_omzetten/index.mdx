...
Het lastige is echter dat we van iets met *kubieke meter* naar iets met *liter* willen gaan. Als we bv. van $\si{cl}$ naar $\si{hl}$ moesten, dan moesten we enkel het voorvoegsel veranderen en konden we [ons trucje met de voorvoegsels](#eenheden-met-voorvoegsels-omzetten) toepassen. Of als we van $\si{m}^3$ naar $\si{hm}^3$ moesten, dan konden we [het trucje met de exponenten](#eenheden-met-exponenten-omzetten) toepassen. Nu zitten we met meter en liter door elkaar... 🥴
...
> 
> <Mute>{String.raw`(Merk op dat we deze methode niet kunnen gebruiken bij een omzetting van $\deg\si{C}$ naad $\deg\si{F}$ omdat $0~\deg\si{C}\ne 0~\deg\si{F}$)`}</Mute>
