...
In onze omzetting van $1{,}84~\si{m}$ hebben we nogal veel vermenigvuldigingen met $1$ staan. Dat zorgt voor schrijfwerk dat we eigenlijk kunnen vermijden. In plaats daarvan gaan we vanaf nu de eenheid rechtstreeks vervangen. De vorige omzetting kunnen we korter schrijven als:
...
<Expand title="Uitbreiding: methode kunnen we niet toepassen bij een omzetting tussen °C en °F omdat 0 °C ≠ 0 °F">
...
import { DrieKubussen } from "./drawings/literIsDm3";
...
import { DrieKubussenMetVolume } from "./drawings/literIsDm3";
...
import { DrieKubussenMetMelk } from "./drawings/literIsDm3";
...
import { Dm3IsMelk } from "./drawings/literIsDm3";

<Dm3IsMelk />

</Expand>

Nu we weten dat $1~\si{l} = 1~\si{dm}^3$, kunnen we **van kubieke meter via kubieke decimeter naar liter te gaan**:
...
<Attention title="Eenheid met kubieke meter omzetten naar eenheid met liter">
...
<Attention title="Eenheid met liter omzetten naar eenheid met kubieke meter">
...
&\overset{\text{BR}}{=} 17{,}5\ldots~\frac{\si{km}}{\si{h}}
\end{aligned}
$$
